        ...
        <div class="col-xs-12">
            ...
            <div class="box-body">
                <form id="myform">
                    ...
                    <div class="box-line">
                        <span class="title mid-inline-block">微信号码：</span>
                        <input class="long" maxlength="20" aria-required="true" required="" name="wechat" value="${store_info.wechat!'' }" placeholder="请输入微信号"/>
                    </div>
                    <div class="box-line">
