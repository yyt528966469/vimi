...
<head >
    ...
    <script>
                    ...
                    },
                    {
                        ...
                        formatter: function(cellvalue,options,rowObject) {
                            ...
                            var v_result="";
                                ...
                                v_result+=" &nbsp;&nbsp;&nbsp; <button  style='width: 70px;' onclick=\"editRes('"+id+"')\" class=\"btn btn-info\" type=\"button\" sec:authorize=\"hasRole('ROLE_ADD')\"  ><i class=\"glyphicon glyphicon-pencil\"></i> 编辑</button>";



                                v_result+=" &nbsp;&nbsp;&nbsp; <button  style='width: 100px;' class=\"btn btn-info\" type=\"button\" sec:authorize=\"hasRole('ROLE_ADD')\" onClick=\"getTree('"+ id+"');\"><i class=\"glyphicon glyphicon-pencil\"></i> 分配权限</button>";

                                if(id!=1){
                                    v_result += " &nbsp;&nbsp;&nbsp; <button  style='width: 70px;' class=\"btn btn-info\" type=\"button\" sec:authorize=\"hasRole('ROLE_ADD')\"  onClick=\"deleteRole('" + id + "');\"><i class=\"glyphicon glyphicon-pencil\"></i> 删除</button>";
                                }
        ...
        function editRes(id) {
            //$("#myiframe").load("sysrole/editRole?id="+id);
            window.location.href="../sysrole/editRole?id="+id;
        }
        ...
        function getTree(id) {
            ...
            layer.open({
                ...
                shade: 0.8,
                area: ['380px', '90%'],
                content: "../sysrole/getTree?id="+id //iframe的url
            });
        }
    </script>
...
<div class="row">
  <div class="col-xs-12">
    <div class="box-header">
      ...
      <button id=""   onclick="editRes('')" class="btn btn-red pull-right">
