    ...
    $(document).ready(function () {
        ...
        $("#table_list").jqGrid({
            ...
            colModel: [
                ...
                {
                    name: 'c_user_info.user_name',
                    index: 'c_user_info.user_name',
                    align : "center",
                    width: 20
                },
                {
                ...
                },
                {
                    ...
                    align : "center",
                    formatter:'select',
                    formatoptions:{value:{ 0:'未处理',1:'已处理'}}
                ...
                },
                {
                    ...
                    formatter: function(cellvalue,options,rowObject) {
                        ...
                        var suggestion_id = rowObject.suggestion_id;
                        //var rank="";
                        var v_result ="";
                            v_result += " &nbsp;&nbsp;&nbsp; <a  class='a_click' style='width:65px;border:none; cursor: pointer;'  onClick='getSuggestion(\"" + suggestion_id + "\");'>查看</a>";
                        return v_result;
                    }
                }
            ],
   ...
   /* $("#searchBtn").click(function(){
    ...
    function getSuggestion(suggestion_id) {
        ...
        layer.open({
            ...
            shade: 0.8,
            area: ['90%', '90%'],
            content: '../suggestion/suggestionDetails?suggestion_id='+suggestion_id //iframe的url
        });
        //if(activit_id)
