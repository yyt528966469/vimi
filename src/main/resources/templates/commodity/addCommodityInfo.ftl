  ...
  <div class="col-xs-12">
    ...
    <div class="box-body">
      ...
      <div class="box-line">
        ...
        <input class="long" maxlength="25" aria-required="true" required="" name="commodity_introduction" value="${commodity_info.commodity_introduction!'' }" placeholder="请输入商品简介"/>
      </div>
            <div class="box-line">
                <span class="title mid-inline-block">商品价格：</span>
                <input class="long" maxlength="25" aria-required="true" required="" name="price" value="${commodity_info.price!'' }" placeholder="请输入商品价格"/>
            </div>
            <div class="box-line">
