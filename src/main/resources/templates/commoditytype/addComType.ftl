  ...
  <div class="col-xs-12">
    ...
    <div class="box-body">
      ...
      <div class="box-line">
        ...
        <input class="long"  maxlength="20" aria-required="true" required=""  name="type_name"  value="${commodity_type.type_name!'' }" placeholder="请输入类型名"/><span style="color: red" id="nameInfo"></span>
      </div>
      <div class="box-line">
        <span class="title mid-inline-block">顺序号：</span>
        <input class="long" maxlength="25" aria-required="true" required="" name="sort" value="${commodity_type.sort!'' }" placeholder="请输入顺序号"/>
      </div>
