...
(function () {
    ...
    function initButtons() {
        ...
        dialog.onok = function () {
            ...
            if(list) {
            	//editor.fireEvent('beforeinsertimage',list);//单独使用图片上传 增加此语句 不然无法触发事件
    ...
    UploadImage.prototype = {
        ...
        initUploader: function () {
            ...
            uploader = _this.uploader = WebUploader.create({
                ...
                accept: {
                    ...
                    mimeTypes: 'image/jpeg,image/jpg,image/png,image/gif,image/bmp'  //'image/*'
                },
            ...
            uploader.on('uploadSuccess', function (file, ret) {
                ...
                try {
                    ...
                    if (json.state == 'SUCCESS') {
                    	...
                    	_this.imageList[$file.index()] = json;//20170821 修改  防止多图片上传显示图片顺序不对
        ...
        getInsertList: function () {
            ...
            for (i = 0; i < this.imageList.length; i++) {
                ...
                /**
                 * 源自于对line：（）的修改，避免部分图片上传失败，或者选择图片不符合规范不能参与上传而造成imageList数组中出现undefined项
                 * */
